# -*- coding: utf-8 -*-
"""
Created on Sat Jan 18 16:45:20 2014

@author: Jason

From http://flask.pocoo.org/snippets/109/
"""
...
def create_managed_session(app, skip_paths=[]):
    fbsm = FileBackedSessionManager(app.config['SESSION_PATH'], 
                                    app.config['SECRET_KEY'])
    csm = CachingSessionManager(fbsm, 1000)
    return ManagedSessionInterface(csm, skip_paths, datetime.timedelta(days=1))
